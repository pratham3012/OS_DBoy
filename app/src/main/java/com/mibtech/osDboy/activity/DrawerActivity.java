...
public class DrawerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isUserLoggedIn()) {
            ...
            tvWallet.setText(getString(R.string.wallet_balance) + "\t:\t" + Constant.SETTING_CURRENCY_SYMBOL + Constant.formatter.format(Double.parseDouble(session.getData(Constant.BALANCE))));
