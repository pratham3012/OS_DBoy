package com.mibtech.osDboy.adapter;
...
public class ItemListAdapter extends RecyclerView.Adapter<ItemListAdapter.HolderItems> {
    ...
    public void onBindViewHolder(@NonNull HolderItems holder, int position) {
        ...
        holder.tvProductListPrice.setText(Constant.SETTING_CURRENCY_SYMBOL + items1.getPrice());
        holder.tvProductListQty.setText(items1.getQuantity());
        holder.tvProductListSubTotal.setText(Constant.SETTING_CURRENCY_SYMBOL + items1.getSubtotal());
